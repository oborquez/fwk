...
class CButtonColumn extends CGridColumn
{
	 ...
	 */
	public $viewButtonOptions=array('class'=>'btn btn-primary btn-sm view');
	...
	public $updateButtonTitle = "Editar";
	/**
	 ...
	 */
	public $updateButtonOptions=array('class'=>'btn btn-primary btn-sm update');
	...
	public $deleteButtonTitle = "Eliminar";
	/**
	 ...
	 */
	public $deleteButtonOptions=array('class'=>'btn btn-primary btn-sm delete');
	/**
	...
	protected function initDefaultButtons()
	{
		if($this->viewButtonLabel===null)
			$this->viewButtonLabel=Yii::t('zii','<i class="fa fa-search"></i>');
		if($this->updateButtonLabel===null)
			$this->updateButtonLabel=Yii::t('zii','<i class="fa fa-edit"></i>');
		if($this->deleteButtonLabel===null)
			$this->deleteButtonLabel=Yii::t('zii','<i class="fa fa-times"></i>');
...
EOD;
	...
	protected function renderButton($id,$button,$row,$data)
	{
		...
		$title=isset($button['title']) ? $button['title'] : $id;
